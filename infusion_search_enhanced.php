                ...
                <form method="POST" action="save_enhanced.php" id="enhanced-infusion-form">
                    ...
                    function displaySecondarySuggestions(results, index, suggestionsDiv) {
                      ...
                      results.forEach(item => {
                        ...
                        div.textContent = `${item.drug_name} - ${item.strength} - ${item.lot_number}`;
                        div.dataset.drugId = item.drug_id;
                        div.dataset.lotNumber = item.lot_number;
                        div.dataset.drugName = item.drug_name;
                        div.dataset.strength = item.strength;
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="secondary_medication_${medicationId}" id="secondary_medication_${medicationId}" class="form-control" placeholder="Medication name">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                ...
                <div class="secondary-medication-section" id="secondary-medication-${medicationId}" style="border: 1px solid #ddd; padding: 15px; margin-bottom: 15px; border-radius: 5px; background-color: #f9f9f9;">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="secondary_medication_${medicationId}" class="control-label">Medication Name:</label>
                                <input type="text" name="secondary_medication_${medicationId}" id="secondary_medication_${medicationId}" class="form-control" placeholder="Medication name" value="${medicationData.order_medication || ''}">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="secondary_expiration_date_${medicationId}" class="control-label">Expiration Date:</label>
                                <input type="date" name="secondary_expiration_date_${medicationId}" id="secondary_expiration_date_${medicationId}" class="form-control" value="${medicationData.order_expiration_date || ''}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
