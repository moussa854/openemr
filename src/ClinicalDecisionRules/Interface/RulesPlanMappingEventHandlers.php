...
/**
 * RulesPlanMappingEventHandlers.php database interaction for admin-gui rules plan mappings.
 *
...
class RulesPlanMappingEventHandlers
{
    ...
    public static function addNewPlan($plan_name, $plan_rules)
    {
        ...
        //Add rules to plan
        self::addRulesToPlan($plan_id, $plan_rules);
    ...
    public static function addRulesToPlan($plan_id, $list_of_rules)
    {
        //Insert
    ...
    public static function removeRulesFromPlan($plan_id, $list_of_rules)
    {
